    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='".route('admin.category.destroy', $query->id)."' class='btn btn-danger delete-item' ml-4><i class='fas fa-trash-alt'></i></a>";

                return $edit . " " . $delete;
            })->addColumn('show_at_home', function($query){
                return $query->show_at_home == 1 ? "<span class='badge badge-success'>Yes</span>" : "<span class='badge badge-danger'>No</span>";
